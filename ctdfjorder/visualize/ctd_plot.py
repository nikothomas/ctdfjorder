...
def plot_secchi_chla(df: pl.DataFrame, plot_folder: str):
    ...
    # Linear regression
    slope, intercept, r_value, p_value, std_err = linregress(secchi_depth, chla)
...
def plot_secchi_log_chla_log(df: pl.DataFrame, plot_folder: str):
    ...
    # Linear regression
    slope, intercept, r_value, p_value, std_err = linregress(log_secchi_depth, log_chla)
...
def plot_secchi_chla_log(df: pl.DataFrame, plot_folder: str):
    ...
    # Linear regression
    slope, intercept, r_value, p_value, std_err = linregress(secchi_depth, log_chla)
